MACHINES = {
  :inetRouter  => {
        ...
        :net => [   
                    ...
                    ["192.168.50.1", 3, "255.255.255.0",  "ansible"],
                ]
  },
  ...
  :centralRouter => {
        ...
        :net => [
                   ...
                   ["192.168.50.2",   7, "255.255.255.0",    "ansible"],
  ...
  :centralServer => {
        ...
        :net => [
                   ...
                   ["192.168.50.3", 3, "255.255.255.0",  "ansible"],
               ]
  },
  :inetRouter2 => {
        :box_name => "generic/ubuntu2204",
        ...
        :net => [
		   ["192.168.255.14", 2, "255.255.255.252",  "router2"],
                   ["192.168.50.10", 3, "255.255.255.0", "ansible"],  # Сеть host-only
               ]
  }
}
